...
По первому клику ЛЕВОЙ клавиши мыши на ячейке происходит покупка валюты, при этом ячейка с купленной валютой помечается желтой рамкой. 
Повторный клик ЛЕВОЙ клавишей по ячейке с желтой рамкой приводит к продаже этой валюты.
